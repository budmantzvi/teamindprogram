...
export const DEFAULT_CONFIG: any = {
  ...
  videoSubtitle_he: 'גלו כיצד טימיינד הופכת מושגי מיומנויות ניהוליות מופשטים לכלים מוחשיים ובלתי נשכחים עבור ילדים.',
  charactersList_he: [
  ...
  faqs_he: [
    { 
      question: "מהי הפילוסופיה המרכזית של טימיינד?", 
      answer: "טימיינד מבוססת על האמונה שתפקודים ניהוליים—'המנכ\"ל של המוח'—הם הכישורים הקריטיים ביותר להצלחה בלימודים ובחיים. אנו משתמשים בלמידה מבוססת דמויות כדי להפוך את התהליכים הקוגניטיביים המופשטים הללו לקונקרטיים ונגישים לילדים." 
    },
    { 
    ...
    { 
      ...
      answer: "כן. טימיינד מבוססת על מחקר נוירו-התפתחותי ופסיכולוגיה קוגניטיבית, תוך התמקדות ספציפית בפיתוח תפקודים ניהוליים בילדות המוקדמת והתיכונה." 
    },
    { 
  ...
  testimonials_he: [
    { name: "שרה ג'.", role: "גננת", text: "טימיינד שינתה לחלוטין את הנוף הדיגיטלי והרגשי של הכיתה שלי. הילדים אובססיביים למיסטר הגה ואדון מוחון!", image: "https://i.pravatar.cc/150?u=sarah" },
    ...
    { name: "מיה ב.", role: "אמא", text: "לפני טימיינד, הבן שלי התקשה במעברים. עכשיו, רק הזכרת 'מיסטר הגה' עוזרת לו להתכונן לפעילות הבאה עם חיוך.", image: "https://i.pravatar.cc/150?u=mayab" },
  ...
  privacyPolicyHtml_he: `
    <h2>מבוא</h2>
    <p>ברוכים הבאים לטימיינד. אנו מחויבים להגן על המידע האישי שלך ועל זכותך לפרטיות. מדיניות פרטיות זו מסבירה כיצד אנו אוספים, משתמשים ומגינים על המידע שלך כאשר אתה מבקר באתר האינטרנט שלנו ומשתמש בשירותים שלנו.</p>
  ...
  termsOfServiceHtml_he: `
    <h2>הסכמה לתנאים</h2>
    <p>על ידי גישה או שימוש באתר ובשירותים של טימיינד, אתה מסכים להיות כפוף לתנאי שימוש אלה. אם אינך מסכים לכל התנאים הללו, אל תשתמש בשירותים שלנו.</p>
    ...
    <h2>החוק החל</h2>
    <p>תנאים אלו יהיו כפופים לחוקי המדינה בה פועלת טימיינד ויפורשו בהתאם להם, ללא התחשבות בהוראות ניגוד חוקים.</p>
  ...
  earlyChildhood_he: {
    ...
    description: 'טימיינד מיושמת באמצעות פעילויות קצרות המותאמות להתפתחות, המשלבות סיפורי שמע, שירים, תנועה, משחק ודמויות ידידותיות.',
    detailsTitle: 'איך זה עובד בכיתה',
    kitTitle: 'ערכת הגיל הרך.',
    kitSubtitle: 'כל מה שצריך כדי ליישם את טימיינד בגן הילדים שלך.',
  ...
  parents_he: {
    ...
    description: 'הבאת פילוסופיית טימיינד לסביבה הביתית.',
