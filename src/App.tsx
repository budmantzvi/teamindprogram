...
function LanguageHandler() {
  ...
  return (
    <Helmet>
      ...
      {/* Favicon / Icon tags for Google Search and Browsers */}
      {/* Google explicitly recommends a 48x48 PNG or an ICO file containing a 48x48 layer. We provide both to be bulletproof. */}
